"""Go2 base MuJoCo sim2sim (flat / legacy terrain, gait-phase obs)."""
...
SCENE_XML = os.path.join(
    LEGGED_GYM_ROOT_DIR, 'resources', 'robots', 'go2', 'MCJF', 'scene_2', 'scene.xml'
)
...
def build_obs_base(count_lowlevel, cfg, q, dq, omega, eu_ang, action, vx_cmd, vy_cmd, yaw_cmd):
    """go2_base: sin/cos phase + cmd + imu + dof + action  (47)."""
